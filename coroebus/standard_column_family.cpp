...
/*
SliceRange* StandardColumnFamily::make_slice_range(const string &column_start, const string &column_finish,
...
int32_t StandardColumnFamily::get_count(const string &key, CL cl)
{
    return get_count(key, "", "", cl);
}

int32_t StandardColumnFamily::get_count(const string &key, const vector<string> &columns, CL cl)
{
    SlicePredicate *sp = new SlicePredicate();
    sp->column_names = columns;
    sp->__isset.column_names = true;
...
int32_t StandardColumnFamily::get_count(const string &key, const string &column_start,
...
int32_t StandardColumnFamily::get_count(const string &key, SlicePredicate *sp, CL cl)
{
    ColumnParent *cp = new ColumnParent();
    cp->column_family = _column_family;
...
map<string, int32_t>
StandardColumnFamily::multiget_count(const vector<string> &keys, CL cl)
{
    return multiget_count(keys, "", "", cl);
}

map<string, int32_t>
StandardColumnFamily::multiget_count(const vector<string> &keys, const vector<string> &columns, CL cl)
{
    SlicePredicate *sp = new SlicePredicate();
    sp->column_names = columns;
    sp->__isset.column_names = true;
...
map<string, int32_t>
StandardColumnFamily::multiget_count(const vector<string> &keys, const string &column_start,
                             const string &column_finish, CL cl)
{
    SlicePredicate *sp = new SlicePredicate();
    SliceRange *sr = make_slice_range(column_start, column_finish, 2147483647);
...
map<string, int32_t>
StandardColumnFamily::multiget_count(const vector<string> &keys, SlicePredicate *sp,
                             CL cl)
{
    ColumnParent *cp = new ColumnParent();
    cp->column_family = _column_family;
